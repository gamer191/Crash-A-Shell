...
class PyNeApple:
    ...
    @overload
    def send_message(self, obj: c_void_p, sel_name: bytes, *, restype: CRet.Str, is_super: bool = False) -> str: ...
    @overload
    def send_message(self, obj: c_void_p, sel_name: bytes, *, restype: CRet.Integral, is_super: bool = False) -> int: ...
    @overload
    def send_message(self, obj: c_void_p, sel_name: bytes, *, restype: CRet.CharSeq, is_super: bool = False) -> Union[bytes, None]: ...
    @overload
